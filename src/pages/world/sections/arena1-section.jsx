...
import Background from "assets/images/world/arena1.jpg";
import HeaderBefore from "assets/images/world/header-effect.png";
import WorldLogo from "assets/images/world/arena1-logo.png";
  ...
  return (
    <Container id="testing" height={size.height}>
      <PageContainer height={size.height}>
        ...
        <WorldModalButton worldName="Mondstadt" />
      </PageContainer>
    </Container>
  );
}
